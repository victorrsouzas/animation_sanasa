...
class DesvincularInteresseScreen extends StatefulWidget {
  const DesvincularInteresseScreen({super.key});

  @override
  State<DesvincularInteresseScreen> createState() =>
      _DesvincularInteresseScreenState();
}

class _DesvincularInteresseScreenState
    extends State<DesvincularInteresseScreen> {
